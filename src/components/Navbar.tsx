...
import { NavbarCanvas } from "@/components/navbar/NavbarCanvas";
...
export const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 relative overflow-hidden">
      <NavbarCanvas />
